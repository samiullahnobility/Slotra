...
{
    /// <inheritdoc />
    public partial class AddAppointmentBookingCore : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StaffAvailability_StaffProfiles_StaffProfileId",
                        column: x => x.StaffProfileId,
                        principalTable: "StaffProfiles",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StaffServices", x => new { x.StaffProfileId, x.ServiceId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StaffServices_StaffProfiles_StaffProfileId",
                        column: x => x.StaffProfileId,
                        principalTable: "StaffProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppointmentNotes_AspNetUsers_AuthorId",
                        column: x => x.AuthorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppointmentNotes_AuthorId",
                table: "AppointmentNotes",
                column: "AuthorId");

            migrationBuilder.CreateIndex(
                name: "IX_Appointments_CustomerId_StartsAt",
                table: "Appointments",
                columns: new[] { "CustomerId", "StartsAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_StaffProfileId_StartsAt_EndsAt",
                table: "Appointments",
                columns: new[] { "StaffProfileId", "StartsAt", "EndsAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StaffAvailability_StaffProfileId_DayOfWeek_StartTime_EndTime",
                table: "StaffAvailability",
                columns: new[] { "StaffProfileId", "DayOfWeek", "StartTime", "EndTime" });
